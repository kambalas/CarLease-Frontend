...
export class MailTemplateService {
  ...
  getRejectionTemplate(data: Partial<GeneralFormsResponse>): string {
    ...
    return `
        <p>Subject: Car Leasing #${applicationId}</p>
        ...
        <p>Best regards, </br> ${this.companyName}, </br> ${this.phoneNumber}, </br> ${this.email}</p>
    `;
  }
  ...
  getMoreInfoTemplate(data: Partial<GeneralFormsResponse>): string {
    ...
    return `
      <p>Subject: Car Leasing Application #${applicationId}</p>
      <p>Dear ${applicantName},</p>
